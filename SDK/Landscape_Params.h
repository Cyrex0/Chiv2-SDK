...
namespace CG
{
	 ...
	 */
	struct ALandscapeProxy_GetLayerInfoObjectByName_Params
	{
	public:
		...
		class ULandscapeLayerInfoObject*                           ReturnValue;                                             // 0x0008(0x0008)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 ...
	 */
	struct ALandscapeProxy_GetAllLayerNames_Params
	{
	public:
		TArray<class FName>                                        LayerNames;                                              // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
