...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ID7C[0x60];                                  // 0x0020(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7OTI[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UUSG[0x4];                                   // 0x0024(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_EVZ2[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XKGQ[0x3];                                   // 0x0021(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MGB0[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_5GGS[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KGN9[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_O107[0xB8];                                  // 0x0000(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2F94[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GFG5[0x3];                                   // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_IKQH[0x7];                                   // 0x02C9(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VQUT[0x10];                                  // 0x00A8(0x0010) MISSED OFFSET (PADDING)
