...
namespace CG
{
	 ...
	 */
	struct ALevelSequenceActor_SequencePlaybackUpdated_Params
	{
	public:
		class UMovieSceneSequencePlayer*                           Sequence;                                                // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		MovieScene_EMovieScenePlayerStatus                         Status;                                                  // 0x0008(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
