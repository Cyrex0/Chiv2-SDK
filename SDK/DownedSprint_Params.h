...
namespace CG
{
	 ...
	 */
	struct UDownedSprint_C_OnAssemble_DownedSprint_Params
	{
	};
	 ...
	 */
	struct UDownedSprint_C_EventBeginFire_Params
	{
	public:
	 ...
	 */
	struct UDownedSprint_C_ExecuteUbergraph_DownedSprint_Params
	{
	public:
