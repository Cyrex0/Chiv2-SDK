...
namespace CG
{
	 ...
	 */
	struct UoptionsSlider_C_OnAnalogValueChanged_Params
	{
	public:
	 ...
	 */
	struct UoptionsSlider_C_OnKeyDown_Params
	{
	public:
		struct FGeometry                                           MyGeometry;                                              // 0x0000(0x0038)  (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	 ...
	 */
	struct UoptionsSlider_C_Construct_Params
	{
	};
	 ...
	 */
	struct UoptionsSlider_C_OnTextCommitted_Params
	{
	public:
	 ...
	 */
	struct UoptionsSlider_C_BndEvt__Slider_0_K2Node_ComponentBoundEvent_0_OnFloatValueChangedEvent__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct UoptionsSlider_C_Tick_Params
	{
	public:
		struct FGeometry                                           MyGeometry;                                              // 0x0000(0x0038)  (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	 ...
	 */
	struct UoptionsSlider_C_ExecuteUbergraph_optionsSlider_Params
	{
	public:
	 ...
	 */
	struct UoptionsSlider_C_Slider_Value_Changed__DelegateSignature_Params
	{
	public:
		float                                                      Value;                                                   // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 ...
	 */
	struct UoptionsSlider_C_TextCommitted__DelegateSignature_Params
	{
	public:
		class FText                                                Text;                                                    // 0x0000(0x0018)  (BlueprintVisible, BlueprintReadOnly, Parm)
