...
namespace CG
{
	 ...
	 * Function:
	 * 		Offset -> 0x02725E80
	 * 		Name   -> Function Landscape.LandscapeProxy.GetLayerInfoObjectByName
	 ...
	 */
	class ULandscapeLayerInfoObject* ALandscapeProxy::GetLayerInfoObjectByName(const class FName& LayerName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Landscape.LandscapeProxy.GetLayerInfoObjectByName");
		
		ALandscapeProxy_GetLayerInfoObjectByName_Params params {};
	 ...
	 * Function:
	 * 		Offset -> 0x02725DD0
	 * 		Name   -> Function Landscape.LandscapeProxy.GetAllLayerNames
	 * 		Flags  -> (Final, Native, Public, HasOutParms, BlueprintCallable)
	 * Parameters:
	 * 		TArray<class FName>                                LayerNames                                                 (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void ALandscapeProxy::GetAllLayerNames(TArray<class FName>* LayerNames)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Landscape.LandscapeProxy.GetAllLayerNames");
		
		ALandscapeProxy_GetAllLayerNames_Params params {};
