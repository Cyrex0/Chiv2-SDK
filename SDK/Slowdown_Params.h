...
namespace CG
{
	 ...
	 */
	struct USlowdown_C_OnAssemble_Slowdown_Params
	{
	};
	 ...
	 */
	struct USlowdown_C_UpdateMovement_Params
	{
	};
	 ...
	 */
	struct USlowdown_C_EventBeginState_Params
	{
	public:
	 ...
	 */
	struct USlowdown_C_ExecuteUbergraph_Slowdown_Params
	{
	public:
