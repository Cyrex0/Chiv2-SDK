...
namespace CG
{
	 ...
	 */
	struct UMovieSceneSequencePlayer_SetPlaybackStatusInternal_Params
	{
	public:
		MovieScene_EMovieScenePlayerStatus                         InStatus;                                                // 0x0000(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 ...
	 */
	struct UMovieSceneSequencePlayer_OnRep_PlaybackCompleted_Params
	{
	};
	 ...
	 */
	struct UMovieSceneSequencePlayer_K2_GetPlaybackStatus_Params
	{
	public:
		MovieScene_EMovieScenePlayerStatusK2                       ReturnValue;                                             // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
