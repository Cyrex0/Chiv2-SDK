...
namespace CG
{
	 ...
	 * Parameters:
	 * 		class UObject*                                     WorldContextObject                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		Ansel_EUIControlEffectTarget                       UIControlTarget                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 ...
	 */
	void UAnselFunctionLibrary::STATIC_SetUIControlVisibility(class UObject* WorldContextObject, Ansel_EUIControlEffectTarget UIControlTarget, bool bIsVisible)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Function:
	 * 		Offset -> 0x00000000
	 * 		Name   -> PredefindFunction UAnselFunctionLibrary.StaticClass
