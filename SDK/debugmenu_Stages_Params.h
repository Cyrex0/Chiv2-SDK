...
namespace CG
{
	 ...
	 */
	struct Udebugmenu_Stages_C_Get_Failtext_Visibility_1_Params
	{
	public:
	 ...
	 */
	struct Udebugmenu_Stages_C_Tick_Params
	{
	public:
	 ...
	 */
	struct Udebugmenu_Stages_C_ExecuteUbergraph_debugmenu_Stages_Params
	{
	public:
