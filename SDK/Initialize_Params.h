...
namespace CG
{
	 ...
	 */
	struct UInitialize_C_OnAssemble_Initialize_Params
	{
	};
	 ...
	 */
	struct UInitialize_C_EventBeginState_Params
	{
	public:
	 ...
	 */
	struct UInitialize_C_EventTick_Params
	{
	public:
	 ...
	 */
	struct UInitialize_C_ExecuteUbergraph_Initialize_Params
	{
	public:
