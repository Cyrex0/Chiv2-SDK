...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_SJIB[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_N7LG[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		Engine_EAspectRatioAxisConstraint                          AspectRatioAxisConstraint;                               // 0x0001(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		...
		unsigned char                                              UnknownData_BCGD[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_WZC7[0x4];                                   // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NCO7[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_C8P1[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_IVZL[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
