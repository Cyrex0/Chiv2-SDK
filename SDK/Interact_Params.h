...
namespace CG
{
	 ...
	 */
	struct UInteract_C_OnAssemble_Interact_Params
	{
	};
	 ...
	 */
	struct UInteract_C_EventBeginFire_Params
	{
	public:
	 ...
	 */
	struct UInteract_C_EventEndState_Params
	{
	public:
	 ...
	 */
	struct UInteract_C_ExecuteUbergraph_Interact_Params
	{
	public:
