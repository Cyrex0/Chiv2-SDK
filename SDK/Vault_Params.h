...
namespace CG
{
	 ...
	 */
	struct UVault_C_OnAssemble_Vault_Params
	{
	};
	 ...
	 */
	struct UVault_C_EventBeginState_Params
	{
	public:
	 ...
	 */
	struct UVault_C_EventEndAnimation_Params
	{
	};
	 ...
	 */
	struct UVault_C_ExecuteUbergraph_Vault_Params
	{
	public:
