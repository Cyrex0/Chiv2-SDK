...
namespace CG
{
	 ...
	 * Function:
	 * 		Offset -> 0x02A6D5A0
	 * 		Name   -> Function LevelSequence.LevelSequenceActor.SequencePlaybackUpdated
	 * 		Flags  -> (Final, Native, Protected)
	 * Parameters:
	 * 		class UMovieSceneSequencePlayer*                   Sequence                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		MovieScene_EMovieScenePlayerStatus                 Status                                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void ALevelSequenceActor::SequencePlaybackUpdated(class UMovieSceneSequencePlayer* Sequence, MovieScene_EMovieScenePlayerStatus Status)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequenceActor.SequencePlaybackUpdated");
		
		ALevelSequenceActor_SequencePlaybackUpdated_Params params {};
