...
namespace CG
{
	 ...
	 */
	enum class MovieScene_EMovieScenePlayerStatusK2 : uint8_t
	{
	...
	public:
		...
		unsigned char                                              UnknownData_VGCU[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WNG6[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_NCR8[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BT9E[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_X1V6[0x58];                                  // 0x0000(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DRBE[0x60];                                  // 0x0000(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_H2NR[0x88];                                  // 0x0000(0x0088) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Q7VJ[0x38];                                  // 0x0000(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_AFGE[0x18];                                  // 0x0000(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_W93C[0x60];                                  // 0x0000(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KMKV[0x60];                                  // 0x0000(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PBKF[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_TJ0Y[0x5];                                   // 0x0013(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TDI4[0x7];                                   // 0x00F1(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		struct FMovieSceneTimeTransform                            LinearTransform;                                         // 0x0000(0x000C) NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_MABB[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_BVSA[0x8];                                   // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_ZNQ8[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_KR1E[0x50];                                  // 0x0050(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5UYI[0x4];                                   // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_945A[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FLWA[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              bClientShouldSyncIfServerCompletedPlayback : 1;          // 0x0014(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              bShouldJumpInsteadOfPlayToEndOnSync : 1;                 // 0x0014(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_GLJI[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MGW8[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FMovieSceneSequenceID, class UObject*>         DirectorInstances;                                       // 0x0020(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_GC84[0x2B8];                                 // 0x0070(0x02B8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UT13[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_H823[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_6CQG[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_TQ5C[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CIHZ[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V3H6[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P08A[0x4];                                   // 0x008C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VYBE[0x3];                                   // 0x0021(0x0003) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_G6NR[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5GMX[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NT64[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_K73O[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Q35J[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NVWC[0x6];                                   // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<bool>                                               Values;                                                  // 0x0020(0x0010) ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_CU4R[0x60];                                  // 0x0030(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RU4D[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3YAK[0x1];                                   // 0x001B(0x0001) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_892M[0x6];                                   // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9RIC[0x3];                                   // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		bool                                                       bHasDefaultValue;                                        // 0x0019(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_7V7K[0x6];                                   // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AQYW[0x60];                                  // 0x0038(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8XOF[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YCTZ[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_23E4[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<int>                                                Values;                                                  // 0x0020(0x0010) ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_1P7Z[0x60];                                  // 0x0030(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1L1Z[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PG81[0x1C];                                  // 0x000C(0x001C) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QW4U[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6WTJ[0x60];                                  // 0x0060(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_W2VH[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_L2RI[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (PADDING)
